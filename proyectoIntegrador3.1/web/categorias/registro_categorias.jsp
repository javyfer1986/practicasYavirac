<%-- 
    Document   : registro_categorias
    Created on : 04/08/2022, 20:27:26
    Author     : advdi
--%>
            ...
            <div class="card " id="formregistrarcat">
                ...
                <form class="row  ">
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <input type="email" class="form-control" id="validarNombre" placeholder="Ingresa el Nombre">
                    </div>
                    <div class="col-sm-12 form-group">
                    ...
                    <!--boton-->
                        <div id="botones">
                            <a href="categorias.jsp" class="btn btn-primary">Registrar</a>
                            <a href="registro_categorias.jsp" class="btn btn-danger ">Borrar datos</a>
                        </div>
                </form>
            </div>
        </div>
