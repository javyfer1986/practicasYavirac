<%-- 
    ...
    Created on : 02/08/2022, 18:30:00
    Author     : advdi
--%>
...
<html>
    <head>
        ...
        <title>Registrar Celulares</title>
    ...
    <body>
        ...
        <div class="card " id="formregistrar">
            ...
            <h1 class="text-center">Registro de Celulares</h1>
            <form class="row  ">
                <!--lista desplegable-->
                ...
                <div class="col-sm-3 form-group">
                    ...
                    <input type="number" class="form-control" id="validarCity" placeholder="Ingresa la Cantidad">
                </div>
                <div class="col-sm-6 form-group">
                    <label for="validarContraseña" class="form-label">Precio:</label>
                    <input type="number" class="form-control" id="validarContraseña" placeholder="Ingresa el Precio">
                </div>
                <div class="col-sm-6 form-group">
                    <label for="validarNombre" class="form-label">Color:</label>
                    <input type="text" class="form-control" id="validarNombre" placeholder="Ingresa el color" >
                </div>
                <div class="col-sm-6 form-group">
                    <label for="validarApellido" class="form-label">Capacidad:</label>
                    <input type="text" class="form-control" id="validarApellido" placeholder="Ingresa la Capacidad">
                </div>
                <div class="col-sm-12 form-group">
                    <label for="validarEmail" class="form-label">Marca:</label>
                    <input type="email" class="form-control" id="validarEmail" placeholder="Ingresa la Marca">
                </div>
                <div class="col-sm-12 form-group">
                    <label for="validarEmail" class="form-label">Modelo:</label>
                    <input type="email" class="form-control" id="validarEmail" placeholder="Ingresa el Modelo">
                </div>
